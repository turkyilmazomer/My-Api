...
import (
	...
	"github.com/turkyilmazomer/my-api/article/repository"
	articleMysqlRepo "github.com/turkyilmazomer/my-api/article/repository/mysql"
	"github.com/turkyilmazomer/my-api/domain"
)
